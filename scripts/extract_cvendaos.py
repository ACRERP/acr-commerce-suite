"""
Script para extrair o segundo banco Access (cVendaOS_v2)
"""
...
ACCESS_DB_PATH = r"C:\cVendaOS_v2"
...
def main():
    print("🔍 Procurando arquivos Access em C:\\cVendaOS_v2...")
    ...
    for db_file in access_files:
        ...
        with open(summary_file, 'w', encoding='utf-8') as f:
            f.write("="*60 + "\n")
            f.write(f"RESUMO DA EXTRAÇÃO - {db_file.name}\n")
            f.write("="*60 + "\n\n")

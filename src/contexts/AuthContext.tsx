...
import {
  ...
  signInWithOAuth as signInWithOAuthClient,
...
interface AuthContextType {
  ...
  signInWithSocial: (provider: 'google' | 'apple' | 'azure') => Promise<{ error: AuthError | null }>
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  async function signInWithSocial(provider: 'google' | 'apple' | 'azure') {
    const { error } = await signInWithOAuthClient(provider)
    return { error }
  }

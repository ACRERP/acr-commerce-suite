      ...
      <Tabs defaultValue="balance" className="space-y-4">
        ...
        <TabsContent value="turnover">
          <Card>
            ...
            <CardContent>
              {/* Chart Section */}
              <div className="h-[300px] w-full mb-8 bg-neutral-50/50 dark:bg-neutral-900/50 p-4 rounded-2xl border border-dashed border-neutral-200 dark:border-neutral-800">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={turnover.slice(0, 10)}>
                    ...
                    <Bar dataKey="turnover_ratio" radius={[4, 4, 0, 0]}>
                      {turnover.slice(0, 10).map((entry, index) => (
                        <Cell key={`cell-${index}`} fill={entry.turnover_ratio > 5 ? '#10b981' : '#3b82f6'} />
                      ))}
                    </Bar>
                  </BarChart>
                </ResponsiveContainer>
